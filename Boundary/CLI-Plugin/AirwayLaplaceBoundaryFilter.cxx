...
#include "AirwayLaplaceBoundaryFilterCLP.h"
...
int DoIt( int argc, char * argv[], T )
{
  ...
  typedef itk::AirwayLaplaceBoundaryImageFilter< InputImageType >  AirwayFilterType;
  ...
  bound->SetNasalPoint(    NPoint    );
  bound->SetNasalVector(   NoseVector    );
  bound->SetTracheaPoint(  TPoint );
  bound->SetTracheaVector( TracheaVector );
